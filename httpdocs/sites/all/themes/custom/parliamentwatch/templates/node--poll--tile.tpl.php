...
<article id="node-<?php print $node->nid; ?>" class="poll tile <?php print $classes; ?>"<?php print $attributes; ?>>
  ...
  <div class="tile__pollchart">
    <div class="tile__pollchart__value_left"><i class="icon icon-ok"></i> <?php print $yays; ?></div>
    ...
    <div class="tile__pollchart__value_right"><i class="icon icon-close"></i> <?php print $nays; ?></i></div>
  </div>
  <?php endif; ?>
