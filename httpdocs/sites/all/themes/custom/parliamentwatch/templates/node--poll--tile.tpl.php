...
<article id="node-<?php print $node->nid; ?>" class="poll tile <?php print $classes; ?>"<?php print $attributes; ?>>
  ...
  <div class="tile__pollchart">
    <div class="tile__pollchart__value_left<?php if ($yays < $nays) { print ' won'; } ?>"><?php print $nays; ?></div>
    ...
    <div class="tile__pollchart__value_right<?php if ($yays > $nays) { print ' won'; } ?>"><?php print $yays; ?></div>
  </div>
  <?php endif; ?>
